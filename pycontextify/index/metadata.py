...
class MetadataStore:
    ...
    def get_chunks_by_source_type(self, source_type: SourceType) -> List[ChunkMetadata]:
        ...
        return [chunk for chunk in self._id_to_metadata.values() 
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        if not self._id_to_metadata:
            return {
                ...
                "relationship_stats": {"total_tags": 0, "total_references": 0, "total_code_symbols": 0},
            }
        ...
        return {
            ...
            "sources": len(set(chunk.source_path for chunk in self._id_to_metadata.values())),
        }
    ...
    def to_dict(self) -> Dict[str, Any]:
        """Convert to dictionary for serialization."""
        return {
            "chunks": {str(faiss_id): chunk.to_dict() 
