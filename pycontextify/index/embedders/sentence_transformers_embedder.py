...
from .base import BaseEmbedder, EmbeddingError, ModelNotFoundError, ProviderNotAvailableError
...
class SentenceTransformersEmbedder(BaseEmbedder):
    ...
    def embed_texts(self, texts: List[str]) -> np.ndarray:
        ...
        try:
            logger.debug(f"Embedding {len(texts)} texts with batch size {self.batch_size}")
