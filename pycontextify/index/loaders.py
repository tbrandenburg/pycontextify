...
class WebpageLoader(BaseLoader):
    ...
    def load(self, url: str, recursive: bool = False, max_depth: int = 1) -> List[Tuple[str, str]]:
    ...
    def _crawl_recursive(self, url: str, max_depth: int, current_depth: int) -> List[Tuple[str, str]]:
            ...
            if current_depth < max_depth - 1:
                ...
                for link in links[:10]:  # Limit links to avoid excessive crawling
                    if self._should_follow_link(link, url):
                        ...
                        sub_pages = self._crawl_recursive(link, max_depth, current_depth + 1)
