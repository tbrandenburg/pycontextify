...
from pycontextify.index.metadata import ChunkMetadata, SourceType, MetadataStore
...
class TestMetadataStore:
    ...
    def test_validate_embedding_compatibility(self):
        ...
        assert store.validate_embedding_compatibility("openai", "text-embedding-3-small")
        ...
        assert store.validate_embedding_compatibility("sentence_transformers", "all-mpnet-base-v2")
        
        # Different embedding should not be compatible
        assert not store.validate_embedding_compatibility("openai", "text-embedding-3-small")
