...
from pycontextify.mcp_server import (
    initialize_manager, perform_initial_indexing, args_to_config_overrides
)
...
class TestMCPServerFunctions:
    ...
    def setup_method(self):
        ...
        mcp_server_module.manager = None
    ...
    def test_index_code_success(self, mock_manager_class):
        ...
        mock_manager.index_codebase.assert_called_once_with(str(test_code_dir.resolve()))
    ...
    def test_index_document_success(self, mock_manager_class):
        ...
        index_document_fn = mcp_server_module.mcp._tool_manager._tools["index_document"].fn
    ...
    def test_index_webpage_success(self, mock_manager_class):
        ...
        index_webpage_fn = mcp_server_module.mcp._tool_manager._tools["index_webpage"].fn
...
class TestMCPServerUtilities:
    ...
    def test_error_handling_in_functions(self):
        ...
        with patch('pycontextify.mcp_server.initialize_manager', 
