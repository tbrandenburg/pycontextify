...
from pycontextify.index.entity_extractor import (
    Entity, EntityExtractor, EntityExtractionResult, extract_entities_from_text,
    RegexEntityExtractor, CompositeEntityExtractor
)
from pycontextify.index.advanced_relationships import (
    RelationshipType, Relationship, SemanticRelationshipExtractor
)
...
class TestKnowledgeGraphBasic:
    ...
    def test_knowledge_graph_import(self):
        ...
        mock_store = Mock()
        mock_store.get_stats.return_value = {'total_entities': 0, 'total_relationships': 0}
