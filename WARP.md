...
**Notes**
- Hybrid search enriches `scores` with both semantic and keyword contributions. Reranking keys may appear in the models but no reranker is currently wired in.
